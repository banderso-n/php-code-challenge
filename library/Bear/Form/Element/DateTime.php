...
class Bear_Form_Element_DateTime extends Zend_Form_Element_Xhtml
{
    ...
    public function getDateTimeFormat()
    {
        if (!$this->_dateTimeFormat) {
            ...
            $this->_dateTimeFormat = Zend_Locale_Format::getDateFormat() . " " . Zend_Locale_Format::getTimeFormat();
        }
    ...
    public function setValue($value)
    {
        ...
        if (is_string($value) && Zend_Date::isDate($value)) {
            die("string date");
     ...
     * @return Bear_Form_Element_DateTime
     */
    public function setYearsRange($startYear, $endYear, $step)
    {
        $this->_yearsRange = array(
            "start" => $startYear,
            "end"   => $endYear,
            "step"  => $step
        );
